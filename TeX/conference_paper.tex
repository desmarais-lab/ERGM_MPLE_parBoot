...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{bias_plots_05}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{rel_time}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{MPLE_histogram_traceplot_cosponsorship}
