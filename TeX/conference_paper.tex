...
\noindent However, the methods introduced by Desmarais and Cranmer \cite{Desmarais.2012} only applied to cases in which the researcher had a large sample of networks (e.g., a time series of networks), since the method they proposed was a non-parametric bootstrap. The non-parametric bootstrap cannot be applied when there is just a single network under study. 
